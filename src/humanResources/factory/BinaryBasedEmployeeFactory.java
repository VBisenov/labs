...
public class BinaryBasedEmployeeFactory extends EmployeeFactory{
    @Override
    ...
    public GroupsManager createDepartmentManager(String name) {
        ...
        dep.setSource(new GroupsManagerBinaryFileSource(".\\test"));
        return dep;
    }
    ...
    public GroupsManager createProjectManager() {
        ...
        pr.setSource(new GroupsManagerBinaryFileSource(".\\test"));
        return pr;
    }
