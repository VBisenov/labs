...
public class TextFileBasedEmployeeFactory extends EmployeeFactory {
    ...
    public GroupsManager createDepartmentManager(String name) {
        ...
        dep.setSource(new GroupsManagerTextFileSource(".\\test"));
        return dep;
    }
    ...
    public GroupsManager createDepartmentManager(String name, EmployeeGroup[] departments) {
        ...
        dep.setSource(new GroupsManagerTextFileSource("C:\\Java\\Output"));
        return dep;
    }
    ...
    public GroupsManager createProjectManager() {
        ...
        pr.setSource(new GroupsManagerTextFileSource(".\\test"));
        return pr;
    }
